import {pgTable, integer, varchar, timestamp, pgEnum, text, uniqueIndex, index, jsonb, unique} from "drizzle-orm/pg-core";
...
export const enrollments = pgTable('enrollments', {
    ...
    index('enrollment_class_id_idx').on(table.classId),
    unique('enrollment_student_class_unique').on(table.studentId, table.classId),
]);
